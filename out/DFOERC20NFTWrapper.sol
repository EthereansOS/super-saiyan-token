 ...
 * It just implements the same functions of the VotingToken of the DFOProtocol, to let it became a Voting Token
 */
...
// File: eth-item-token-standard/ERC20NFTWrapper.sol
...
// File: contracts/DFOERC20NFTWrapper.sol
    ...
    function transferFrom(
        ...
        if (
            ...
            _approve(
                sender,
                txSender,
                _allowances[sender][txSender] = _allowances[sender][txSender]
            );
        }
        return true;
    }
